export const moduleAdd = (entityData, scriptPath, containerSelector) => {
    ...
    console.log("entity data from module add", entityData);
    console.log(entityData.modules.findIndex(mod => mod.type === default_module.type), `${parseInt(default_module.type)+1}`);

    default_module.type = getType(entityData, default_module.type);
    console.log(default_module.type);
